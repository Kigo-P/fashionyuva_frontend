        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Field as="select" name="size" className="w-full px-4 py-3 border border-gray-300 rounded-lg ">
            ...
            <div>
              ...
              <Field as="select" name="category" className="w-full px-4 py-3 border border-gray-300 rounded-lg ">
