              ...
              <div className="space-y-6">
                {cartItems.length === 0 ? (
                  <div className="h-[50vh] flex flex-col items-center justify-center gap-10">
                    ...
                    <ShoppingCart className="mr-2 h-40 w-40" />
                    <Link
                      to="/listing"
                      className="flex w-min whitespace-nowrap items-center justify-center rounded-lg bg-black px-5 py-2.5 text-sm font-medium text-white hover:bg-gray-400 focus:outline-none focus:ring-4 focus:ring-gray-300"
                    >
                      start shopping
                    </Link>
                  </div>
