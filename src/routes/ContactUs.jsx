    ...
    <div className="min-h-screen bg-white text-black flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-6xl bg-white shadow-2xl rounded-lg overflow-hidden flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 p-8 bg-black text-white">
          ...
          <p className="mb-6 text-gray-300">We'd love to hear from you. Drop us a line about anything fashion.</p>
          <div className="space-y-4">
            <p className="flex items-center">
              <span className="font-semibold mr-2"><MapPin /></span> 4th Street Ngong Avenue
            </p>
            <p className="flex items-center">
              <span className="font-semibold mr-2"><Phone/></span> +254715503942
            </p>
            <p className="flex items-center">
              <span className="font-semibold mr-2"><Mail /></span> hello@fashionyuva.com
            </p>
          </div>
